...
import com.spring.dev.converter.RoleToUserProfileConverter;
...
First interesting thing is registration converter we created in previous step with Spring configuration 
using addFormatters. Next is the method configurePathMatch which provides a workaround (although other 
workaround exists) for a known bug in spring, which is still found in Spring 4.1.7.RELEASE.
