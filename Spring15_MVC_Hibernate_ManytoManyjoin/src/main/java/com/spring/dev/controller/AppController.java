...
import com.spring.dev.service.UserService;
...
public class AppController
{
	 ...
	 */
	@RequestMapping(value =
	{ "/newuser" }, method = RequestMethod.GET)
    ...
    public String saveUser(@Valid User user, BindingResult result,
         ...
         * Below mentioned peace of code [if block] is to demonstrate that you can fill custom errors outside the 
 		 *	validation framework as well while still using internationalized messages.
         * 
         */
	 ...
	 */
	@RequestMapping(value =
	{ "/edit-user-{ssoId}" }, method = RequestMethod.GET)
	 ...
	 */
	@RequestMapping(value =
	{ "/edit-user-{ssoId}" }, method = RequestMethod.POST)
	 ...
	 */
	@RequestMapping(value =
	{ "/delete-user-{ssoId}" }, method = RequestMethod.GET)
